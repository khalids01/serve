        ...
        <CardContent className="space-y-5">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Field
              ...
              label="Auto-backup image metadata every (minutes)"
            ...
            >
              <Input
                ...
                onChange={(e) =>
                  onChange({
                    ...form,
                    jsonIntervalMinutes: Number(e.target.value),
                  })
                }
              />
            </Field>
            <Field
              ...
              label="Auto-backup database every (minutes)"
            ...
            >
              <Input
                ...
                onChange={(e) =>
                  onChange({
                    ...form,
                    sqlIntervalMinutes: Number(e.target.value),
                  })
                }
              />
            </Field>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Backups older than these windows are removed when you run Clean
              old backups or on the next scheduled cleanup.
            </p>
