  ...
  return (
    ...
    >
      ...
      <div className="aspect-video bg-muted relative">
        {isPdf(img.contentType) ? (
          ...
          <>
            ...
            <button
              ...
              className="absolute left-1/2 top-1/2 z-[1] flex h-12 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-2xl bg-red-600 text-white shadow-lg transition-transform hover:scale-105"
              aria-label={`Play ${img.originalName}`}
            >
        ...
        {/* Overlay Actions */}
        <div className="absolute inset-0 z-[2] bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
          <Button
            variant="secondary"
            size="icon"
            onClick={() => onPreview(img)}
          ...
          <Button variant="secondary" size="icon" asChild title="Download">
            <a href={url} download>
